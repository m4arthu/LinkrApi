...
import { deletePostById, updatePostById, getHashtag, getPostByTrend, getPostByUserId, GetPublish, SharePublish, ShareRepost } from "../controllers/share.controller.js";
const timelineRoute = express();

timelineRoute.post('/timeline',validateSchema(ShareSchema),validateAuth, SharePublish);
timelineRoute.post('/timeline/:id',validateAuth, ShareRepost);
